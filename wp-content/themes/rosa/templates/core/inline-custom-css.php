...
if ( isset( $fonts['google_titles_font'] ) ) { ?>
	/*  for PRO users! -  Titles classes here */
...
if ( isset( $fonts['google_subtitles_font'] ) ) { ?>
	/*  for PRO users! -  Subtitles classes here */
	.headline__secondary {
...
if ( isset( $fonts['google_nav_font'] ) ) { ?>
	/*  for PRO users! -  Nav classes here */
	.navigation a {
...
if ( isset( $fonts['google_body_font'] ) ) {
	...
	$font_size = '14px'; ?>
	/*  for PRO users! -  Body classes here */
