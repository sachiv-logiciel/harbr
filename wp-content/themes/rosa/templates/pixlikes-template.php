...
/*  for PRO users! - *echo '<a class="pixlikes-box '.$display_only.'" href="#" '.$data_id.' title="'. $title .'" style="background-color: #345; display:block; width:30px; height:30px">'. $likes_number .'</a>';
...
<div id="pixlikes" class="share-item  pixlikes-box  <?php echo $display_only . ' ' . $class ?>"  <?php echo $data_id ?>>
	...
	<span class="likes-text">
		<span class="likes-count"><?php echo $likes_number ?></span>&nbsp;<?php _e( 'likes', 'rosa_txtd' ) ?>
	</span>
	</span>
</div>