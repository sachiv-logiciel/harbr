...
if ( !empty($terms ) /*  for PRO users! - && wpgrade::option('display_product_filters', '0')*/ ) {
	...
	if ( !empty($all_link) ) {
		...
		echo '<li><a href="', $all_link ,'"', ( !isset( $current_term->term_id ) ) ? ' class="active"' : ' class="inactive"' ,'>', __('All Products', 'rosa_txtd' ) , '</a></li>';
	}
