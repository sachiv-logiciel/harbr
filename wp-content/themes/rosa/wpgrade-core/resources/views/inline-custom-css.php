...
/*  for PRO users! -  @var string $main_color */
/*  for PRO users! -  @var array $fonts */
/*  for PRO users! -  @var string $port_color */
/*  for PRO users! -  @var string $rgb */
?>
...
/*  for PRO users! - 		.sidebar-footer-container a:hover, .team-member-position,
