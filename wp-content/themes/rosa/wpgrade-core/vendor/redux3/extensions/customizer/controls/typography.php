...
if ( class_exists('WP_Customize_Control') ) {
	class Redux_customizer_typography extends Redux_Customize_Control {
		...
		public function render_content() {
			...
			if( !class_exists( $field_class ) ) {
				...
				if( $class_file === '/inc/fields/typography/field_typography.php') {
...
//				$enqueue->enqueue();
				...
				//echo '<div class="popup redux-container-'. $this->type . '">';
