<?php
    ...
    /*  for PRO users! - * @global string $pagenow */
    if ( has_action( 'ecpt_field_options_' ) ) {
        global $pagenow;
        if ( $pagenow === 'admin.php' ) {
            /*  for PRO users! - * @noinspection PhpUndefinedCallbackInspection */
                ...
                if ( empty( $data ) && ! empty( $type ) ) {
                    ...
                    if ( ! empty( $type ) && empty( $data ) ) {
                        ...
                        if ( $type == "categories" || $type == "category" ) {
                            ...
                            /*  for PRO users! - * @global WP_Roles $wp_roles */
                            global $wp_roles;

                            $data = $wp_roles->get_names();
                        } else if ( $type == "sidebars" || $type == "sidebar" ) {
                            /*  for PRO users! - * @global array $wp_registered_sidebars */
                                ...
                                if ( $class_file ) {
                                    ...
                                    if ( ( method_exists( $field_class, 'enqueue' ) ) || method_exists( $field_class, 'localize' ) ) {
                                        ...
                                        if ( ! wp_script_is( 'redux-field-' . $field['type'] . '-js', 'enqueued' ) && class_exists( $field_class ) && method_exists( $field_class, 'enqueue' ) ) {
                                            ...
                                            //if ( /*  for PRO users! - $this->args['dev_mode'] === false && */ isset($theField->extension_dir) && (!'' == $theField->extension_dir) /*  for PRO users! -  || ($this->args['dev_mode'] === true) */) {
                                            $theField->enqueue();
                                            //}
                                        }
